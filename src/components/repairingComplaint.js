...
class repairingComplaint extends Component {
  constructor(props) {
    super(props);
    this.state = {
      images: [   
  ...
  render() {
    ...
    <Text style={{fontSize:20, color:'black', marginHorizontal:50}}>Product & Complaint</Text>
    </View>
    ...
    <ScrollView>
     <View >
      {this.state.images.map((key, index)=>{
        return(
          <TouchableOpacity onPress={()=>{this.props.navigation.navigate('Select2')}} style={{width:'90%',justifyContent:'center',height:190,elevation:0.5,borderRadius:5,marginHorizontal:'5%', marginTop:15,  backgroundColor:'transparent'}}>
...
export default repairingComplaint;
